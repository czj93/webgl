function subtractVectors(a: Array<number>, b: Array<number>, dst?: Array<number>) {
  dst = dst || new Array(3).fill(0);
  dst[0] = a[0] - b[0];
  dst[1] = a[1] - b[1];
  dst[2] = a[2] - b[2];
  return dst;
...
function normalize(v: Array<number>, dst?: Array<number>) {
  dst = dst || new Array(3).fill(0);
...
function cross(a: Array<number>, b: Array<number>, dst?: Array<number>) {
  dst = dst || new Array(3).fill(0);
...
export default {
  ...
  identity: function() {
    ...
    lookAt: function(cameraPosition: Array<number>, target: Array<number>, up: Array<number>, dst?: Array<number>) {
    ...
    inverse: function(m: Array<number>, dst?: Array<number>) {
